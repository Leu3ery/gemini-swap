...
print('[GitHub] Tagging v1.1.4...')
sys.stdout.flush()
subprocess.run(['git', 'tag', '-fa', 'v1.1.4', '-m', 'Release v1.1.4'], check=True)
...
release_notes = """### ⚡ Gemini Swap v1.1.4 - Seamless Antigravity Account Synchronization
...
- **macOS App**: [`GeminiSwap-macOS.zip`](https://github.com/Leu3ery/gemini-swap/releases/download/v1.1.4/GeminiSwap-macOS.zip) (Native Swift App with Menu Bar Mode)
- **Linux VPS (x64)**: [`gemini-swap-linux-amd64.tar.gz`](https://github.com/Leu3ery/gemini-swap/releases/download/v1.1.4/gemini-swap-linux-amd64.tar.gz)
- **Linux VPS (ARM64)**: [`gemini-swap-linux-arm64.tar.gz`](https://github.com/Leu3ery/gemini-swap/releases/download/v1.1.4/gemini-swap-linux-arm64.tar.gz)
- **macOS CLI (Apple Silicon)**: [`gemini-swap-darwin-arm64.tar.gz`](https://github.com/Leu3ery/gemini-swap/releases/download/v1.1.4/gemini-swap-darwin-arm64.tar.gz)
- **macOS CLI (Intel)**: [`gemini-swap-darwin-amd64.tar.gz`](https://github.com/Leu3ery/gemini-swap/releases/download/v1.1.4/gemini-swap-darwin-amd64.tar.gz)
- **Windows (x64)**: [`gemini-swap-windows-amd64.zip`](https://github.com/Leu3ery/gemini-swap/releases/download/v1.1.4/gemini-swap-windows-amd64.zip)
"""

release_cmd = ['gh', 'release', 'create', 'v1.1.4',
               '--title', 'Gemini Swap v1.1.4 - Seamless Antigravity Account Sync',
               '--notes', release_notes] + assets

res = subprocess.run(release_cmd, env=env, capture_output=True, text=True)
print('Release result:\n', res.stdout, res.stderr)
print('✓ Successfully released v1.1.4!')
sys.stdout.flush()
